<!-- PROJECT TITLE -->
<h1 align="center">Movie-Reviews-Sentiment-Analysis-Binary-Classification</h1>
...
1. Clone the repo
   ```sh
   git clone https://github.com/ShehrozRafaqat/Movie-Reviews-Sentiment-Analysis-Binary-Classification.git
   ```
